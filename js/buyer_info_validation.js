document.addEventListener("DOMContentLoaded", function () {
    ...
    // ----------------------------
    // LIVE VALIDATION (uniform style like register page)
    // ----------------------------
    ...
    form.addEventListener("submit", function (e) {
        ...
        if (!isAnyChecked()) {
            showCuisineError("Please select at least one preference");
            hasError = true;
        }
